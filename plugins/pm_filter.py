...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_message(chat_id=message.from_user.id, text="Sorry, The file name you requested doesnt seem available, Try checking the spelling or Request the series in [our group](https://t.me/requestyourseries_movies).")
            return
